...
public class UserDataLoader {
    ...
    public void loadCustomers() {
        // Skip seeding if customers already exist
        if (userRepository.findByEmail("user1@example.com").isPresent()) {
            System.out.println("Customer users already exist, skipping seed.");
            return;
        }
    ...
    public void loadDealerUsers() {
        // Skip seeding if dealers already exist
        if (userRepository.findByEmail("dealer1@example.com").isPresent()) {
            System.out.println("Dealer users already exist, skipping seed.");
            return;
        }
    ...
    public void loadAdminUsers() {
        // Skip seeding if admins already exist
        if (userRepository.findByEmail("admin1@example.com").isPresent()) {
            System.out.println("Admin users already exist, skipping seed.");
            return;
        }
